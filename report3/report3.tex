...
I solved this problem using a modified version of a numerical method available in \textit{www.numbercrunch.de} written by H. Bauke. The aim of the method is to calculate the functions in equation (\ref{eq:27}) using the recurrence relation 
