...
I have already explained that when a non-Hermitian Hamiltonian satisfies \PT-symmetry (unbroken) the energy spectrum of the Hamiltonian in question has all real eigenvalues.
Does this mean that the Hamiltonian I studied can be used to describe actual physics? The short answer is yes. The long answer requires the definition of a new non-trivial linear operator called the \emph{C} operator. However, this topic was beyond my research. 
