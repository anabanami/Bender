...
\captionof{figure}{These are 6 frames of my simulation of a right propagating Gaussian wave packet in space as a function of time.The horizontal axes of every frame correspond to the spatial coordinate x (dimensionless) and the vertical axes of every frame correspond to the real and imaginary parts of the Gaussian wave packet. The earliest time frame is the top left panel, corresponding to wave packet at time t =  15600 as can be seen in that plot's title. The panels in this arrangement should be studied from left to right and top to bottom. An ``undesirable" reflection of the real part of the wave packet at the boundary is visible specially in the last 3 frames from left to right, corresponding to times t = 24000, t = 26800 and t = 29600 as can be seen in the plots' titles from left to right respectively.}
\end{Figure}
...
\begin{Figure}
 ...
 \captionof{figure}{These are 6 frames in the visualisation of the behaviour of the first and second excited states for the Hamiltonian in equation (\ref{eq:17}) in the region of broken \PT-symmetry. The horizontal axes of each plot represent the x coordinate, and the vertical axes represent the wave functions. In addition to the legend I have added on the top left corner of each of the plots the corresponding eigenvalues to each of the wave functions, and the corresponding $\epsilon$ value to make note of this parametric dimension. On the top left panel, the $\epsilon$ value is most negative. The plots in this arrangement should be studied from left to right and top to bottom. Here I demonstrate how the structure of the eigenstates changes as we approach the $\epsilon$ value corresponding to the \textbf{exceptional point} (approximately $\epsilon = -0.576$). As $\epsilon$ varies, we can see the wave functions behave as mirror images of each other when the $\epsilon$ value is more negative than the exceptional point. Then at the approximate value of the exceptional point (visible in the top right plot), the wave functions overlap. As the $\epsilon$ values become less negative than the exceptional point, the states themselves become symmetric about zero. At the bottom right plot, we see that the states are the first and second excited states of the harmonic oscillator, ie. $\epsilon = 0$.}
\end{Figure}

\begin{Figure}
 \centering
 \includegraphics[width=\linewidth]{amplitudes.pdf}
 \captionof{figure}{These are 6 frames in the visualisation of the behaviour of the probability density of the first and second excited states for the Hamiltonian in equation (\ref{eq:17}) in the region of broken \PT-symmetry.Similarly to the previous figure, the horizontal axes of each plot represent the x coordinate, and the vertical axes represent the probability density of the states. In addition to the legend I have added on the top left corner of each of the plots the corresponding eigenvalues to each state, and the corresponding $\epsilon$ value to make note of this parametric dimension. On the top left panel, the $\epsilon$ value is most negative. The plots in this arrangement should be studied from left to right and top to bottom. Here I demonstrate how the eigenstates densities change as we approach the $\epsilon$ value corresponding to the \textbf{exceptional point} (approximately $\epsilon = -0.576$). As $\epsilon$ varies, we can see the densities behave as mirror images of each other when the $\epsilon$ value is more negative than the exceptional point. Then at the approximate value of the exceptional point (visible in the top right plot), the densities overlap. As the $\epsilon$ values become less negative than the exceptional point, the densities themselves become symmetric about zero. At the bottom right plot, we see that the states densities correspond to those of the first and second excited states of the harmonic oscillator, ie. $\epsilon = 0$.}
\end{Figure}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\subsection{The full version of the figure}\label{Final}
\begin{Figure}
 \centering
...
\begin{center}
\vspace{10cm}
\includegraphics[scale=0.2]{bepdep.pdf}
\vspace{10cm}
\end{center}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
